...
Revision ID: d6217cf6cfbb
Revises: 
Create Date: 2025-08-28 10:35:55.161826
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['departmentId'], ['Department.id'], name='fk_department_id'),
    ...
    op.create_index(op.f('ix_ProfilePhoto_id'), 'ProfilePhoto', ['id'], unique=False)
    op.create_table('UserCredential',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('userId', sa.Integer(), nullable=False),
    sa.Column('email', sa.String(length=255), nullable=False),
    sa.Column('hashedPassword', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['userId'], ['User.id'], name='fk_user_credential_user_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('userId')
    )
    op.create_index(op.f('ix_UserCredential_email'), 'UserCredential', ['email'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_ProfilePhoto_id'), table_name='ProfilePhoto')
